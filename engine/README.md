...
Current numbers (9 pages, 242 detected lines, on-device): **all 242 read**, 241 identical to an fp32 reference; on the 6-page recall set 160 of 161 boxes read (99.4%), OCR 4.9 s vs 7.5 s with the previous int8 model; detection averages **0.79 s/page**, mixed-precision OCR **1.25 s/page** — 23% less than the int8 OCR it replaced.
